...
4. **Visualisation in Power BI**  (Unable to show due to sensitive DWP data)
...
## Impact
- Fully automated MI Pack processing, eliminating manual steps and providing visualisations  
